...
public class BrokenLinksTest {
	...
	public static void main(String[] args)
	{
		...
		//driver.get("http://ultimateqa.com/automation");
		...
		for(int i=0;i<listlink.size();i++)
		{
			...
			System.out.println("eachlink value:"+eachlink);//getting all the website links
			...
			try 
			{
			   ...
			   HttpURLConnection httpurlconnection=(HttpURLConnection) url.openConnection();//open the url connnection
				...
				statusCode=httpurlconnection.getResponseCode();//get response code
